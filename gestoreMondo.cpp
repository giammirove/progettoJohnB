...
/*
    Ritorna in base alla x in input se è necessario
    generare un nuovo oggetto
*/
bool GestoreMondo::necessitoDiGenerareOggetto(int x)
{
    if (_oggettoPrec == NULL || x > _oggettoPrec->getFigura()->x)
    {
        return true;
    }
    return false;
